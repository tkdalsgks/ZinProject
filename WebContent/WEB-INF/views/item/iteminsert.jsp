...
<table class='inserttable'>
	...
	<tr><td class='insertname'>물품명</td><td><input type="text" name="item_name" class="insertinput" id="shop_name" maxlength=20 required></td></tr>
	...
	<tr><td class='insertname'>물품가격</td><td><input class="insertinput" type="number" name="item_price" min=10 required></td></tr>
