...
<table class='inserttable'>
	<form action="itemmod" method="post">
		...
		<tr><td class='insertname'>물품명</td><td><input type="text" name="item_name" class="insertinput" id="item_name" value="<%=request.getAttribute("item_name")%>" maxlength=20 required></td></tr>
		...
		<tr><td class='insertname'>물품가격</td><td><input type="number" name="item_price" class="inputinput" id="item_price" min=10 value="<%=request.getAttribute("item_price") %>" required></td></tr>
